...
export default function AddPayrollPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const [teacherData, sessionData] = await Promise.all([
  ...
  return (
    <DashboardLayout title="Add Payroll">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) => setForm((prev) => ({ ...prev, basicSalary: event.target.value }))}
              />
            </div>
            <div className="space-y-2">
              <Label>Month</Label>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) => setForm((prev) => ({ ...prev, transportAllowance: event.target.value }))}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) => setForm((prev) => ({ ...prev, otherAllowances: event.target.value }))}
              />
            </div>
